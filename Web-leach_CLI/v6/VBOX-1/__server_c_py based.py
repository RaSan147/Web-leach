...
def read_wltxt(f_code):
	...
	return_box.append("<h2><u>Description</u>: </h2> <br><code class='language-pug'><pre>" + "\n".join(text_[1:]) + "</code></pre>")
	...
	try:
		...
		return_box.append('<br><br><h2><u>Source Code</u>:</h2> <br><pre><code class="language-py">' + inspect.getsource(eval('func_.' + where)) + "</code></pre>")
	except:
		traceback.print_exc()
