		...
		'content="text/html; charset=%s">' % enc)
			...
			'content="text/html; charset=%s">' % enc)
				...
				while self.decrypto_dat!=[]:
					...
					try:
						column[0]= "%s/%s/%s &nbsp&nbsp&nbsp %s: %s: %s" %Nsys.dec_dt(_decrypto_dat[0])
					except KeyError: pass
					except IndexError as e:
						try:
							if re.search(r'\d+/\d+/\d+ &nbsp&nbsp&nbsp \d: \d: \d.?\d*', _decrypto_dat[0]):
								pass
							else:
								raise e
						except: continue
					...
					####################################################
						...
						if fcode == '0306':
							...
							if ecode == '1':
								...
								column[4] = '<b>Project: </b>'+ _decrypto_dat[3] + '<br>' + '<b>Link: </b>' + _decrypto_dat[5] + '<br>' + '<b>Header dex: </b>' + _decrypto_dat[4] + '<br><b>Status/Error Code: </b>' + _decrypto_dat[5] + '<br>' + '<b>Error Message: </b>' + _decrypto_dat[6]
							...
							if ecode == '1':
								column[3] = '<b><u>Failed to index links from Webtoon</u></b>'
