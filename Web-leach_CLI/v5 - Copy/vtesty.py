...
StringFileInfo(
  ...
  StringTable(
    ...
    StringStruct(u'FileDescription', u'Web Leach'),
    StringStruct(u'FileVersion', u'0.5.500004'),
    StringStruct(u'InternalName', u'Web Leach'),
    StringStruct(u'LegalCopyright', u'Copyright (c) The Apache Software Foundation'),
    StringStruct(u'OriginalFilename', u'Web Leach 0.5.5.4.exe'),
    StringStruct(u'ProductName', u'Web Leach'),
    StringStruct(u'ProductVersion', u'0.5.5.4')])
  ]), 
