...
class ProjectType_:  # fc=0P00
	...
	def store_current_data(self): #fc=????
		...
		json_proj = json.dumps(dataset, cls=SetEncoder)
		json_list = json.dumps({"all_list": self.all_list.all_links}, cls=SetEncoder)
